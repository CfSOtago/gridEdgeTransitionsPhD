...
ReshapeDT <- gather(ReshapeDT, "obsHalfHour", "kWh", HHPeriod_1:HHPeriod_50) #Combine the wide format into a long format
...
ReshapeDT <- ReshapeDT[, time:= ifelse(obsHalfHour=='HHPeriod_39', '14:00:00', time)]
...
names(LubridateDT)[names(LubridateDT) == "Reference"] <- "iD"
