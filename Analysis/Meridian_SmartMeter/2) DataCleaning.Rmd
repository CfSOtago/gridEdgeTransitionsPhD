...
t1 <- copy(dataBucketS)
t1 <- t1[complete.cases(t1$dateTime), ] #Remove entries where no dateTime was recorded n=10,000
t1 <- t1[, naKWH := sum(is.na(kWh)), keyby =. (dateTime)] #Creates a variable showing NAs in kWh for dateTime
