...
dataBucketS <- dataBucketS[, season := ifelse(dataBucketS$month=="2" | dataBucketS$month=="3", "Summer", season)]
dataBucketS <- dataBucketS[, season := ifelse(dataBucketS$month=="4" | dataBucketS$month=="5", "Autumn", season)]
dataBucketS <- dataBucketS[, season := ifelse(dataBucketS$month=="7" | dataBucketS$month=="8", "Winter", season)]
dataBucketS <- dataBucketS[, season := ifelse(dataBucketS$month=="11" | dataBucketS$month=="12", "Spring", season)]
...
noSolarMeridianDT <- data.table::fwrite(NAomitDT,  "~/greenGridData/externalData//Meridian/2_Cleaned/noSolarMeridianSeasonal.csv")
